...
import {
  ...
  CreditCard, Receipt, Bell, LogOut, PanelLeft, Dumbbell, RefreshCw,
} from "lucide-react";
...
export default function DashboardLayout({
  ...
  if (!isAuthenticated) {
    // Redirect handled by App.tsx router; this is a safety net
    return null;
  }
...
function DashboardLayoutContent({
  ...
  const { user, logout, activeCompanyId, companies } = useFitConnectAuth();
          ...
          <SidebarFooter className="p-3">
            ...
            {activeCompany && !isCollapsed && (
              <div className="mb-2 px-1">
                <Badge
                  variant="outline"
                  className="w-full justify-center text-xs truncate cursor-pointer"
